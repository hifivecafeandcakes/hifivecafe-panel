...
const CandleLightDinnerPayment = () => {
  ...
  const [result, setResult] = useState([])
    const handleFromDateChange = (e) => {
      ...
      const handleClick = (e) => {
        ...
        setLoading(true);
        axios.get(`${process.env.REACT_APP_API_URL}payment/candle/light/dinner?fromdate=${fromDate}&todate=${lastDate}`)
          .then((res) => {
  ...
  const handleDownloadCSV = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        saveAs(blob, 'Candle_light_dinner_payment.csv');
      }
    });
  };
            ...
            <div className="card card-default mt-3">
              <div className="card-header ">
                <h3 className="card-title">
                 Candle Light Dinner payemet success List
                </h3>
...
export default CandleLightDinnerPayment