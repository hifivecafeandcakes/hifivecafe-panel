  ...
  const [result, setResult] = useState([])
    const handleFromDateChange = (e) => {
      ...
      const handleClick = (e) => {
        ...
        setLoading(true);
        axios.get(`${process.env.REACT_APP_API_URL}waiting/table/booking?fromdate=${fromDate}&todate=${lastDate}`)
          .then((res) => {
  ...
  const handleDownloadCSV = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        saveAs(blob, 'TABLE_BOOKING_WAITING.csv');
      }
    });
  };
        ...
        <div className="col-lg-12 my-3 px-3">
          <div className="row">
            <div className="col-lg-12">
              <div className="card">
                <div className="card-header">
                  <h3 className="card-title"> Table Booking List</h3> <Button className='btn bg-primary ml-5' style={{fontSize:"10px"}} onClick={handleDownloadCSV}>csv</Button>
                  <div className="card-tools">
                    <div
...
export default TableBookingWaitingList