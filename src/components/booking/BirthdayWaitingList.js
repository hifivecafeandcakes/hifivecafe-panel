  ...
  const [result, setResult] = useState([])
    const handleFromDateChange = (e) => {
      ...
      const handleClick = (e) => {
        ...
        setLoading(true);
        axios.get(`${process.env.REACT_APP_API_URL}waiting/birthday/list?fromdate=${fromDate}&todate=${lastDate}`)
          .then((res) => {
  ...
  const transformData = (data) => {
    ...
    return data.map((item, i) => {
      const renamedItem = {
        ...
        RESERVATION:(item.reservation_type ? "TABLE BOOKING" :""), 
        ...
        <div className="col-lg-12 my-3 px-3">
          <div className="row">
            <div className="col-lg-12">
              <div className="card">
                <div className="card-header">
                  <h3 className="card-title"> Birthday Booking List</h3> <Button className='btn bg-primary ml-5' style={{fontSize:"10px"}} onClick={handleDownloadCSV}>csv</Button>
                  <div className="card-tools">
                    <div
                      ...
                      <Table className="table table-hover text-nowrap">
                        ...
                        {result.map((item, index) => (
                              <TableRow key={index}>
                                ...
                                <TableCell className='text-center'>{item.reservation_type=="BP" ? "BIRTH DAY" :""}</TableCell>
...
export default BirthdayWaitingList