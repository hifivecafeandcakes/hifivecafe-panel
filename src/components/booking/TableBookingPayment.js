  ...
  const [result, setResult] = useState([])
    const handleFromDateChange = (e) => {
      ...
      const handleClick = (e) => {
        ...
        setLoading(true);
        axios.get(`${process.env.REACT_APP_API_URL}payment/table/booking?fromdate=${fromDate}&todate=${lastDate}`)
          .then((res) => {
  ...
  const handleDownloadCSV = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        saveAs(blob, 'TABLE_BOOKING_payment.csv');
      }
    });
  };
            ...
            <div className="card card-default mt-3">
              <div className="card-header ">
                <h3 className="card-title">
                 Table Booking payemet success List
                </h3>
        ...
        <div className="col-lg-12 my-3 px-3">
          <div className="row">
            <div className="col-lg-12">
              <div className="card">
                <div className="card-header">
                  <h3 className="card-title"> Table Booking payemet success List</h3> <Button className='btn bg-primary ml-5' style={{fontSize:"10px"}} onClick={handleDownloadCSV}>csv</Button>
                  <div className="card-tools">
                    <div
                      ...
                      <Table className="table table-hover text-nowrap">
                        ...
                        {result.map((item, index) => (
                              <TableRow key={index}>
                                ...
                                <TableCell className='text-center'>{item.reservation_type ? "TABLE BOOKING" :""}</TableCell>
...
export default TableBookingPayment