                        ...
                        <TableHead className='bg-warning'>
                          <TableRow style={{ fontSize: '13px' }}>
                            ...
                            <TableCell className='text-center'>Gallery Category Title</TableCell>
                              ...
                              <TableCell className='text-center'>Gallery Category Image</TableCell>
                        ...
                        <TableBody>
                          {result?.map((item, index) => (
                            <TableRow key={index}>
                              ...
                              <TableCell className='text-center'>{item.gallery_title}</TableCell>
