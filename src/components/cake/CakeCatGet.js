                        ...
                        <TableHead className='bg-warning'>
                          <TableRow style={{ fontSize: '13px' }}>
                            <TableCell className='text-center'>S.NO</TableCell>
                              ...
                              <TableCell className='text-center'>Cake Category Title</TableCell>

                              <TableCell className='text-center'>Cake Category Image</TableCell>
                        ...
                        <TableBody>
                          {result?.map((item, index) => (
                            <TableRow key={index}>
                              ...
                              <TableCell className='text-center'>{item.cake_title}</TableCell>                              

                              <TableCell className='text-center'>
                                <ImageIcon
                                  className='text-primary'
                                  onClick={() => window.open(item.cake_img, '_blank')} 
                                  style={{ cursor: 'pointer' }}
                                />
                              </TableCell>

                              <TableCell className='text-center'>{item.menu_status == '1' ? "Active" : "Inactive"}</TableCell>

                              <TableCell className='text-center'>
                                {item.created_at ? (new Date(item.created_at).toISOString().slice(0, 10).split('-').reverse().join('-')) : '-'}
