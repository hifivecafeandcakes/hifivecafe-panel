...
const CakeCatAdd = () => {
  ...
  const handleSubmit = (e) => {
    ...
    formData.append('cake_title', Title);

    if (Image) {
      formData.append('cake_img', Image);
    }

    axios
      .post(`${process.env.REACT_APP_API_URL}/cake/category/add`, formData)
      .then(function (res) {
        ...
        if (res?.data?.Response?.Success == '1') {
          ...
          window.location.href = '/panel/subadmin/CakeCatGet';
