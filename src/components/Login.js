...
// import logo from '../spark images/logoimg.png'
...
import IdLottie from '../theme/assets/face.json'
import PasswordLottie from '../theme/assets/password.json'



export default function Login() {

  const panelname = "Sub Admin"
  ...
  console.log(ipAddress, panelname);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (!email || !password) {
        Swal.fire({
          icon: 'error',
          title: 'Please Enter your Employee Id and Password.',
          position: 'center',
        });
        return;
      }
        ...
        <div className="login-box" style={{ marginLeft: 'auto', marginRight: 'auto', paddingTop: '20vh', paddingBottom: 'auto', width: '45vh' }}>
          <div className="login-logo">
            ...
            {/* <img
              style={{
                width: '20vh',
                animation: 'zoom 2s ease-in-out infinite', // Applying the zoom animation
              }}
              src={logo}
              alt="Logo"
            /> */}
  ...
  border-radius: 100px;
  position: relative;
  box-shadow: 0 0 calc(var(--active) * 3em) calc(var(--active) * 1em) hsl(260 98% 90% / 0.75),
